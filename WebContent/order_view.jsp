	...
	<div id="shopping">
		<form action="doBuy" method="post">
			<table id="oderview">
				...
				<tr id="${od.hp_id}">
					<td class="thumb"><img style="width: 100px; height: 100px;" src="${od.goods.hp_file_name }" />
						<a href="doView?pId=${od.hp_id }">${od.goods.hp_name }</a>
					</td>
					<td class="price" >
						<span >单价：${od.goods.hp_price }</span>
					</td>
					<td class="number">
							<span>${od.hod_quantity }</span>
					</td>
