...
<body>
	...
	<div id="position" class="wrap">
		...
		<a href="doPage?cate=parent&hpcId=${pro.parent_category.HPC_ID }">${pro.parent_category.HPC_NAME }</a> &gt; 
		<a href="doPage?cate=child&hpcId=${pro.child_category.HPC_ID }">${pro.child_category.HPC_NAME }</a>
	</div>  
		...
		<div id="product" class="main">
			...
			<div class="introduce">
				...
				<div class="text">
					...
					<input type="hidden"  value="${p.hp_stock }" id="sk"/>
				</div>
			</div>
		</div>
		<div class="clear"></div>
	...
	<script type="text/javascript">
		/* function addToCart(ele){
			...
			$.ajax({
				type:"get",
				url:"doAddCart?pid="+ ele+"&count="+ count, 
