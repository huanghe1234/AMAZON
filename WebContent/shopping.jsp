		...
		<form action="doBuy" method="post">
			<table id="tb_1">
				...
				<tr id="product_${shopping.id }">
					<td class="thumb">
					<img style="width: 100px; height: 100px;" src="${shopping.goods.hp_file_name }" />
					<a href="doView?pId=${shopping.goods.hp_id }">${shopping.goods.hp_name }</a>
					</td>
			...
			<div class="button"><input type="button" value="" onclick="mySend()"/></div>
		</form>
	</div>
</div>
<div id="footer">
