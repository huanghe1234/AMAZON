...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>请键入找回密码的相关信息：</h1>
			<form id="loginForm" method="post" action="doRetrieve">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="text" id="uName" name="identity" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><label class="ui-green"><input type="button" name="submit" value="提交" onclick="myRetrieve()"/></label></td>
					</tr>
				</table>
			</form>
		</div>
