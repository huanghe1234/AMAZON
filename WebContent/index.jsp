			...
			<!--分页下标开始-->
				<div class="pager">
					<ul>
							...
							<li><a href="doPage?cate=${param.cate}&page=${pager.prevPage }&hpcId=${param.hpcId}" id="lastPage">上一页</a></li>
							...
							<li><a href="doPage?cate=${param.cate}&page=${pager.nextPage}&hpcId=${param.hpcId}" id="nextPage">下一页</a></li>
