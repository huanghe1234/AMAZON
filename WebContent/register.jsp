			...
			<form id="regForm" method="post" action="doAction?action=register" ><!-- onsubmit="return checkForm(this)" -->
				<table>
					...
					<tr>
						...
						<td><input value="" class="text" type="password" name="rePassWord" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input value=""  id="email" class="text" type="text" name="email"  onfocus="FocusItem(this)" onblur="CheckItem(this);"/><span id="uemail"></span></td>
					</tr>
					<tr>
						<td class="field">手机：</td>
						<td><input value="" class="text" type="text" name="mobile" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
						<td class="field">地址：</td>
						<td><input value="" class="text" type="text" name="address" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						<td></td>
						<td><label class="ui-green"><input type="button" name="submit" value="提交注册" onfocus="checkForm(this)" onclick="myFormPost()"/></label></td>
					</tr>
				</table>
			</form>
		</div>
